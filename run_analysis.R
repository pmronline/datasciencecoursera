...
# 2. Extracts only the measurements on the mean and standard deviation (SD) for each measurement. 
...
# Load X_test, y_test, subject_test data
...
# Extract only the measurements on mean and SD for each measurement
